...
## Latest Metrics (2026-03-06 16:18)
| Metric | Value |
|--------|-------|
| Step | 0 / 50,000 |
| Loss | 3.7125 |
| Grad Norm | 2.17 |
| Learning Rate | 0.004201 |
| Tokens/sec | 260 |
| Elapsed | 1h (5900s) |
...
| **5090-v4** | **143M tok** | **0/50K** | **3.7125** | **Current (lr=0.006, 65K files, 187 repos)** |
...
---
*Auto-updated by monitor_5090.sh every 30 min at 2026-03-06 16:18:29*
