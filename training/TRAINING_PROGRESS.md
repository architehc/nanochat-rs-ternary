...
## Latest Metrics (2026-03-06 19:18)
| Metric | Value |
|--------|-------|
| Step | 0 / 50,000 |
| Loss | 3.3832 |
| Grad Norm | 1.79 |
| Learning Rate | 0.003484 |
| Tokens/sec | 253 |
| Elapsed | 4h (16597s) |
...
| **5090-v4** | **143M tok** | **0/50K** | **3.3832** | **Current (lr=0.006, 65K files, 187 repos)** |
...
---
*Auto-updated by monitor_5090.sh every 30 min at 2026-03-06 19:18:35*
