...
## Latest Metrics (2026-03-06 09:20)
| Metric | Value |
|--------|-------|
| Step | 0 / 30,000 |
| Loss | 3.0970 |
| Grad Norm | 1.94 |
| Learning Rate | 0.006756 |
| Tokens/sec | 963 |
| Elapsed | 2h (9170s) |
...
| **5090-v3** | **106M tok** | **0/30K** | **3.0970** | **Current (lr=0.008, resumed from v2/4K)** |
...
---
*Auto-updated by monitor_5090.sh every 30 min at 2026-03-06 09:20:05*
