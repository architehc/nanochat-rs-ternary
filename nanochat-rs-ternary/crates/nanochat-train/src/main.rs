...
fn resolve_train_config(config: &str) -> Option<TrainConfig> {
    match config {
        ...
        "nano-275m-engram-v11" | "nano_275m_engram_v11" => {
            Some(TrainConfig::nano_275m_engram_v11())
        }
        "nano-275m-engram-v12" | "nano_275m_engram_v12" => {
            Some(TrainConfig::nano_275m_engram_v12())
        }
        "nano-275m-engram-v13" | "nano_275m_engram_v13" => {
            Some(TrainConfig::nano_275m_engram_v13())
        }
        "nano-275m-engram-v14" | "nano_275m_engram_v14" => {
            Some(TrainConfig::nano_275m_engram_v14())
        }
