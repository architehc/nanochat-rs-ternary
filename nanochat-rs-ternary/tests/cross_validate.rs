//! Cross-validation: compare Python and Rust model outputs.
//!
//! Requires reference data generated by `training/gen_reference.py`.
//!
//! To generate reference data:
//!   cd training && python gen_reference.py
//!
//! To run this test:
